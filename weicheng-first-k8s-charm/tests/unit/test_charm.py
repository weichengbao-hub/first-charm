...
from charm import SERVICE_NAME, WeichengFirstK8SCharmCharm
...
def test_pebble_ready(monkeypatch: pytest.MonkeyPatch):
    ...
    # Arrange:
    ctx = testing.Context(WeichengFirstK8SCharmCharm)
    ...
    monkeypatch.setattr("charm.weicheng_first.get_version", mock_get_version)
